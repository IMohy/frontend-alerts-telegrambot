...
class JahizTracker {
  private config: Required<
    Pick<JahizConfig, "webhookUrl" | "webhookSecret">
  > &
    JahizConfig;
  ...
  private parseStack(
    stack: string
  ): { fileName?: string; lineNumber?: number; functionName?: string } {
  ...
  private collectBrowserInfo(): Partial<DeviceInfo> {
    ...
    return {
      ...
      architecture: (nav as Navigator & { userAgentData?: { platform?: string } })
